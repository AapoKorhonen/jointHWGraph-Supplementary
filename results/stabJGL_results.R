...
results_stabJGL_p_50_n_20_group_data_s_0.9 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
  
  set.seed(i)
  data_R <- p_50_n_20_group_data_s_0.9[[i]]
  
  res <- stabJGL::stabJGL(data_R)
  ...
  adj.mat3 <- res$opt.fit[[3]] != 0 # the estimated adjacency matrix of graph 3
...
save(results_stabJGL_p_50_n_20_group_data_s_0.9, file="results/result_files/results_stabJGL_p_50_n_20_group_data_s_0.9.RData")
...
results_stabJGL_p_50_n_50_group_data_s_0.9 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
...
save(results_stabJGL_p_50_n_50_group_data_s_0.9, file="results/result_files/results_stabJGL_p_50_n_50_group_data_s_0.9.RData")
...
results_stabJGL_p_50_n_100_group_data_s_0.9 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
...
save(results_stabJGL_p_50_n_100_group_data_s_0.9, file="results/result_files/results_stabJGL_p_50_n_100_group_data_s_0.9.RData")
...
results_stabJGL_p_50_n_20_group_data_s_0.5 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
...
save(results_stabJGL_p_50_n_20_group_data_s_0.5, file="results/result_files/results_stabJGL_p_50_n_20_group_data_s_0.5.RData")
...
results_stabJGL_p_50_n_50_group_data_s_0.5 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
...
save(results_stabJGL_p_50_n_50_group_data_s_0.5, file="results/result_files/results_stabJGL_p_50_n_50_group_data_s_0.5.RData")
...
results_stabJGL_p_50_n_100_group_data_s_0.5 <- foreach(i = 1:t1, .packages=c('stabJGL'), .options.snow = opts) %dopar% {
...
save(results_stabJGL_p_50_n_100_group_data_s_0.5, file="results/result_files/results_stabJGL_p_50_n_100_group_data_s_0.5.RData")
